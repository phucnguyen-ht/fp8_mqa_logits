...
export bs=8
export version=2
export profile_dir="profile/v2/ver$version/conc$bs_2"
...
rocprofv2 -i $counters -d $profile_dir python3 test_fp8_paged_mqa_logits.py --profile --batch $bs -kv_length 65536 -mtp 0 --tuned_csv oldtune/paged_fp8_mqa_logits_tuned.csv --profile --version $version
